...
#define option_rst_common	option_rst_common_x2
const gp_set_t *option_rst_common_x2 = NULL; //&_pb8_rst_gpio_set;
...
const spi_dev_t devconf_XXXXXx2[BOARD_SPI_COUNT] = {
	...
	#else
	#define devconf_at413_spi2(info, spi_setting_name, cs_setting_name, gpport, pin, gpio_crm_clk) \
		{ \
			info, \
			{"SPI2", SPI2, CRM_SPI2_PERIPH_CLOCK}, \
			spi_setting_name, \
			...
			cs_setting_name, \
			{gpport,	pin, 			gpio_crm_clk, 				GPIO_MODE_OUTPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}, /* //(PB12) Test-ISP2 OK */ \
	...
	devconf_at413_spi1("AT32F413 ETHERNET SPI1", "sck/mi/mo/ pa5/pa6/pa7", "cs/ pa15", GPIOA, GPIO_PINS_15, CRM_GPIOA_PERIPH_CLOCK),
	devconf_at413_spi2("AT32F413 ETHERNET SPI2", "sck/mi/mo/ pb13/pb14/pb15", "cs/ pb12", GPIOB, GPIO_PINS_12, CRM_GPIOB_PERIPH_CLOCK),
	...
	devconf_at413_spi2("AT32F413 ETHERNET SPI2", "sck/mi/mo/ pb13/pb14/pb15", "cs/ pa4", GPIOA, GPIO_PINS_4, CRM_GPIOA_PERIPH_CLOCK),
	#endif
};
...
//[common.macro]
//#define spidev()					devconf[pin_code]
...
//#define gpio_wire_sck()			devconf[pin_code].wire_sck //FIELD_SPIDEV(wire_sck)
...
//#define scfg_info()				(((struct modscfg_st *)intr_pack)->scfg_inf)
//#define scfg_crm()				(((struct modscfg_st *)intr_pack)->scfg_init.scfg_clk)
//#define scfg_port()				(((struct modscfg_st *)intr_pack)->scfg_init.scfg_port_src)
//#define scfg_pin()				(((struct modscfg_st *)intr_pack)->scfg_init.scfg_pin_src)
//#define intr_data_scfg()			(((struct modscfg_st *)intr_pack)->extend) //(((intr_param_t *)intr_pack)->scfg)
//#define intr_gpio_data()			(((struct modscfg_st *)intr_pack)->option)
//#define intr_gpio_exister()		exint_data() ? intr_gpio_data() ? 1 : 0 : 0
