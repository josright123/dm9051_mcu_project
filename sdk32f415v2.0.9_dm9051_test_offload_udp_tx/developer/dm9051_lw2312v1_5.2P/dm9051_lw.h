...
#define MBNDRY_DEFAULT		MBNDRY_WORD //MBNDRY_BYTE
...
#define display_ids(fstr, ids)				printf("...%s...          chip ids: %02x %02x %02x %02x %02x\r\n", fstr, ids[0], ids[1], ids[2], ids[3], ids[4])
