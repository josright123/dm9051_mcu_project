...
const uint16_t led_gpio_pin[LED_NUM]           = {LED2_PIN, LED3_PIN, LED4_PIN};
const crm_periph_clock_type led_gpio_crm_clk[LED_NUM] = {LED2_GPIO_CRM_CLK, LED3_GPIO_CRM_CLK, LED4_GPIO_CRM_CLK};
...
void uart_print_init(uint32_t baudrate)
{
  ...
  gpio_init_struct.gpio_pins = PRINT_UART_RX_PIN;   // set RX pin
  gpio_init(PRINT_UART_RX_GPIO, &gpio_init_struct); // initialize RX pin
  ...
  usart_receiver_enable(PRINT_UART, TRUE); // enable UART receiver
